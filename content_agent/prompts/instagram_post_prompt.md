...
4. **Promptul de poza complet** — dupa ce alegi ideea, ruleaza si Agentul 1 (`instagram_photo_prompt.md`) pentru aceeasi idee si include promptul complet de poza (in romana, gata de copy-paste), nu doar o descriere scurta. Poza: prim-plan, lumina naturala, produsul sau look-ul in centru. **Mereu prompt pentru ChatGPT — Andreea nu face poze** (vezi `identitate_vizuala.md`); pentru produsele ei reale descrii ambalajul real si adaugi nota "incarca si poza produsului in ChatGPT ca referinta". O postare fara imagine nu e continut publicabil — nu livra doar caption-ul.
