# Produse încercate — SageBeauty

> Singura sursa de adevar pentru ce produse/experiente poti mentiona ca reale in continut (review-uri, comparatii, rutini). SageBeauty nu vinde nimic — asta e un jurnal de produse pe care Andreea le-a incercat efectiv, nu un catalog de vanzare. Agentii nu inventeaza produse, rezultate sau opinii care nu sunt aici — daca lipseste ceva relevant, intreaba inainte sa scrie.

## Branduri folosite (fara parere/produs specific inca)

Andreea a confirmat ca foloseste produse de la aceste branduri, dar fara detalii de produs anume/
parere/experienta inca — **nu sunt suficiente pentru continut de tip review sincer** (vezi
`content_strategy.md`: categoria aia are nevoie de o intrare completa in tabelul de mai jos). Se pot
folosi doar ca reper general (ex: mentionate generic intr-o postare de tip rutina), nu ca sursa de
opinie:

Tatcha, Glow Recipe, Beauty of Joseon, Rare Beauty, Tarte, Anastasia Beverly Hills, Charlotte Tilbury,
MAC, YSL (Yves Saint Laurent Beauty), Estée Lauder, MUP, Alix Avien, Huda Beauty.

Cand Andreea cere continut despre un produs anume de la unul din aceste branduri, se intreaba
parerea/experienta pe loc si se adauga in tabelul de mai jos.

## Produse incercate (cu parere si experienta concreta)

> Preluate de pe [Glow Diary](https://glowdiary.pythonanywhere.com) (site-ul propriu al Andreei cu recenzii complete) — vezi si `brand.md`. Daca apar recenzii noi acolo, se pot importa la fel.

| Produs | Brand | Categorie | De unde / pret | Il recumpar | Parerea mea reala |
|---|---|---|---|---|---|
| Reddition Body Cleanser | Terre de Mars | Gel de dus | Goodiebox, 99 lei | Nu neaparat — il tine mai mult pt experienta senzoriala | Mirosul m-a prins de la primul dus — nu dulceag, ceva mai adult, aproape ca un parfum. Consistenta usor cremoasa, la apa devine spuma fina, deloc lipicioasa. Pielea dupa dus — ok, nu extraordinar, nici tare hidratata, nici trasa. Il folosesc cu placere mai ales pt experienta senzoriala, nu pt un rezultat vizibil. Nu ma face sa renunt la altceva. |
| Pink Dew Gel Cleanser | Summer Fridays | Curatare ten | Sephora, 90 lei | Da | Il folosesc aproape zilnic. Curata bine fara sa simt ca tenul "scartaie" dupa clatire. Textura de gel devine spuma fina, miros discret placut, deloc inabusitor. Pielea ramane confortabila dupa — nu simt nevoia sa aplic imediat o crema, ma "tine". Recomandat pt ten normal, mixt sau usor deshidratat. |
| The Dewy Skin Cream | Tatcha | Crema hidratanta | Sephora, 135 lei | — (nu mentionat explicit) | De cand am adaugat-o in rutina de seara, ma trezesc cu tenul mai catifelat si plin, nu tras. Textura groasa dar se aplica usor, fara senzatia de strat gros. Miros discret, floral. Efect "dewy" — ten hidratat din interior, nu doar uns la suprafata. Pt piele uscata, mai ales iarna, face diferenta pe termen lung. Recomandat pt ten uscat, mixt spre uscat, deshidratat. |
...
|---|---|---|---|---|
| Easy Blur Primer | Huda Beauty | Primer | 7-8/10 (actualizat 2026-09-23; in postarea TikTok aparea 3/10 — nota veche, nu se mai foloseste) | "E ok." Tine cam jumatate de zi cand e cald — dar am si tenul mai ciudat (mixt), deci nu e doar vina primerului. (Motivul din postare, "nu rezonez cu siliconul", NU se foloseste: tubul e silicone-free.) |
...
Denona Mini Palette (fard). **Pudra de fixare o pune doar pe frunte si pe partea de jos a obrazului** — nu peste zonele cu contur, blush sau iluminator (Andreea, 2026-09-26). Deci ordinea ei (pudra de fixare dupa contur/blush/iluminator) e corecta pentru tehnica ei, nu o greseala. Contur, blush si iluminator sunt **pudre** (2026-09-25; produsele exacte nu sunt numite). **Neconfirmate inca:** pudra de fixare, ruj,
