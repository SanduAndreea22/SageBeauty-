...
"prompt de poza" → Agent 1; "postare"/"caption" → Agent 2; "reel"/"reels" → Agent 3). Daca cere mai
multe deodata, ruleaza-le pe rand, in ordine: poza → postare → reel. Daca cererea e ambigua si nu
